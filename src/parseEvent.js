...
const SYSTEM_PROMPT = `You are a calendar assistant. Extract event details from natural language text.
...
Resolve relative dates (e.g. "next Monday", "tomorrow") against today's date.`;
